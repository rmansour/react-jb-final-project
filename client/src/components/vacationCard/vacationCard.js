    ...
    return (
            <div className="vacation__card">
                ...
                <main className="vacation__card--body">
                    <header className="vacation__card--body-header">
                    ...
                    {vacation.description.length > MAX_LENGTH ?
                        (
                            <p className="vacation__card--body-description">
                                {
                                    `${vacation.description.substring(0, MAX_LENGTH)} ... `
                                }
                            </p>
                        ) :
                        <p className="vacation__card--body-description">{vacation.description}</p>
                    }
